...
<script src="{{ asset('font-awesome/js/regular.js') }}"></script>
<script src="{{ asset('font-awesome/js/solid.js') }}"></script>
<script src="{{ asset('font-awesome/js/fontawesome.js') }}"></script>
