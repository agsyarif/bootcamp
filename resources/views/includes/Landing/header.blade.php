<section
    class="h-full w-full border-box transition-all duration-500 linear lg:px-16 md:px-20 px-8 py-4 backdrop-blur sticky top-0 backdrop-filter">
        ...
        <div class=" mx-auto flex flex-row items-center justify-between">
            ...
            <div class="flex w-2/4 justify-beetween">
                ...
                <div class="hidden lg:flex lg:items-center lg:w-auto w-full lg:ml-auto lg:mr-auto flex-wrap items-center text-base justify-center"
                    ...
                    <nav
                        ...
                        <a href="{{ route('index') }}"
                            class="font-bold block hover:text-gray-900 {{ request()->is('/') ? 'nav-link active' : 'nav-link text-serv-text' }}">Home</a>

                        <a href="{{ route('explore.landing') }}"
                            class="font-bold block hover:text-gray-900 {{ $active === 'explore' ? 'nav-link active' : 'nav-link text-serv-text' }}">Bootcamp</a>

                        <a href="{{ route('about') }}"
                            class="font-bold block hover:text-gray-900 {{ $active === 'about' ? 'nav-link active' : 'nav-link text-serv-text' }}">About</a>
                        @auth
                            ...
                            <a class="bg-red-400" href="#">
                                <div class="flex items-center pt-8 pl-5 space-x-2 border-t border-gray-100">
                                    ...
                                    <img src="{{asset('assets/images/user.png')}}"
                                        class="inline ml-2 h-10 w-10 rounded-full" />
                                    @endif
            ...
            <div class="lg:flex lg:items-center lg:w-auto md:w:auto w-full  mob:menu" id="menu">
                <button onclick="toggleModal('loginModal')"
                    class="text-serv-login1-text hover:text-serv-login1-text hover:bg-gray600 mx-5 hover:text-gray-900 items-center border-0 block lg:inline-block lg:py-3 lg:px-10 focus:outline-none rounded font-medium text-base mt-6 lg:mt-0 backdrop-blur">
                    Log In
                </button>

                <button onclick="toggleModal('registerModal')"
                    class="lg:bg-serv-services-bg hover:bg-gray600 text-serv-login-text items-center border-0 block lg:inline-block  lg:py-3 lg:px-10 focus:outline-none rounded font-medium text-base mt-6 lg:mt-0 backdrop-blur">
                    Sign Up
                </button>
