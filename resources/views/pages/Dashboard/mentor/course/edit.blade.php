                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <div class="flex space-x-2">
                                                <select id="category" name="category_id" autocomplete="category"
                                                    ...
                                                    @foreach ($course_category as $ctg)
                                                        @if ($course->course_category_id == $ctg->id)
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <textarea placeholder="Jelaskan Service apa yang kamu tawarkan?" type="text" name="description" id="description"
                                                ...
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                rows="4" value="{{ $course->description }}">{{ $course->description ?? '' }}</textarea>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="harga kelas Bootcamp" type="number" name="price"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <div class="col-span-6 pb-6 sm:col-span-3">
                                                <select id="is_publish" name="is_publish" autocomplete="is_publish"
                                                    class="block w-full px-3 py-3 pr-10 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                                    required>
                                                    ...
                                                    <option value={{ 1 }}
                                                        @if ($course->is_published == 1) selected @endif>Active
                                                    </option>
                                                    <option value={{ 0 }}
                                                        @if ($course->is_published == 0) selected @endif>Non Active
                                                    </option>
                                                    {{-- @endif --}}
                                                    {{-- @endforeach --}}
