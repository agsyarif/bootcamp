            ...
            <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                <div class="col-span-12">
                    ...
                    <p class="text-sm text-gray-400">
                        UNggah kursus yang anda sediakan
                    </p>
        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a href="{{ route('courses.index') }}" class="text-gray-400">Kursus</a>
                ...
                <li class="flex items-center">
                    <a href="#" class="font-medium">Upload</a>
                </li>
                            ...
                            <div class="">
                                <div class="px-4 py-5 sm:p-6">
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <x-form for='title' forView='Judul Kursus' placeholder='Judul kursus' type='text' name='title' id='title' isRequired='true' />

                                        <x-form.select-id id='category' name='category_id' nameView='Kategori Kursus' isRequired=true collection="{!! json_encode($categories) !!}" >

                                            <a href="{{ route('categories.create') }}"
                                                class="rounded-lg"
                                                style="background-color: rgb(185, 185, 185)">
                                                <svg width="20" height="20" fill="green" aria-hidden="true">
                                                    <path
                                        ...
                                        <x-form for='slug' forView='slug' placeholder='Slug-Judul-Kursus' type='text' name='slug' id='slug' isRequired='true' />

                                        <x-form.select-id id='courseLevel' name='course_level' nameView='Kategori Kursus' isRequired=true collection="{!! json_encode($level) !!}" />
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <x-form for='price' forView='Harga Kursus' placeholder='Harga Kursus' type='number' name='price' id='price' isRequired='true' />

                                            <a for="thumbnail" onclick="defaultBtnActive()" id="custom-btn"
                                                class="block w-full py-3 pl-5 mt-4 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm text-center">Choose
                                                a Image</a>
...
@push('after-script')
    ...
    <script type="text/javascript">
        document.getElementById('title').addEventListener('input', function() {
            // Mendapatkan nilai dari input title
            var titleValue = document.getElementById('title').value;

            // Mengubah nilai title menjadi format kebab-case
            var slugValue = titleValue.toLowerCase().replace(/\s+/g, '-');

            // Mengisi nilai ke input slug
