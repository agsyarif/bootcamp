                    ...
                    <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                        <div class="col-span-12">
                            ...
                            <p class="text-sm text-gray-400">
                                Upload Lessons to the Chapter <span class="font-bold">{{$chapter->title}}</span> You Provided
                            </p>
                ...
                <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
                    <ol class="inline-flex p-0 list-none">
                        ...
                        <li class="flex items-center">
                            <a href="{{ route('dashboard.index') }}" class="text-gray-400">My Dashboard</a>
                                        ...
                                        <div class="px-4 py-5 sm:p-6">
                                            ...
                                            <div class="grid grid-cols-6 gap-6">
                                                ...
                                                <div class="col-span-6">
                                                    ...
                                                    <label for="chapter_id" class="block mb-2 font-medium text-gray-700 text-md">Chapter</label>

                                                    <div class="flex space-x-2">

                                                            <select name="chapter_id" id="chapter_id" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    <label for="title" class="block mb-3 font-medium text-gray-700 text-md">Materi</label>
                                                    <input placeholder="Your Lesson" type="text" name="title[]" id="title" autocomplete="title" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('title') }}" required>
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    ...
                                                    <label for="video" class="block mb-3 font-medium text-gray-700 text-md">Video Materi</label>
                                                    <input type="file" name="video[]" id="video" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('video') }}">
    ...
    @push('after-script')
        ...
        <script type="text/javascript">
            ...
            function editChapter(){
                $("#chapter_title").removeAttr('readonly');
            }
        </script>
                ...
                html += '<div class="px-4 py-5 sm:p-6">\
                    <div class="grid grid-cols-6 gap-6">\
                        <div class="col-span-6 sm:col-span-3">\
                            ...
                            <div class="col-span-6 sm:col-span-3">\
                                <label for="video" class="block mb-3 font-medium text-gray-700 text-md">Video Materi</label>\
                                <input type="file" name="video[]" id="video" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('video') }}">@if ($errors->has('video'))<p class="text-red-500 mb-3 text-sm">{{ $errors->first('video') }}</p>\
                                    @endif\
                                </div>\
                                    </div>\
                                    </div>';
