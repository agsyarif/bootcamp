                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <input placeholder="Mentor name ??" type="text" name="name" id="name"
                                                autocomplete="name"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <select id="is_active" name="is_active" autocomplete="is_active"
                                                ...
                                                <option value=1 {{ $mentor->is_active == 1 ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option value=0 {{ $mentor->is_active == 0 ? 'selected' : '' }}>
                                                    Disabled
                                                </option>
