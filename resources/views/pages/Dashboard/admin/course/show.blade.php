    ...
    <main class="h-full overflow-y-auto">
            ...
            <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                ...
                <div class="col-span-4 lg:text-right">
                    <div class="relative mt-0 md:mt-6">
                        ...
                        {{-- <form action="{{ route('member-management.destroy', $course->id) }}" method="post">
                            @method('delete')
                            @csrf
        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a href="#" class="font-medium">Details Course</a>
                </li>
                        ...
                        <section class="pt-6 pb-20 mx-8 w-auth">
                            <div class="grid gap-5 md:grid-cols-12">
                                ...
                                <div class="p-4 md:text-right lg:col-span-6 md:col-span-12">
                                    ...
                                    <a href="{{ route('member-management.edit', $course->id) }}"
