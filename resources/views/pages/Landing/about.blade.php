    ...
    <div class="relative">
        ...
        <div class="content">
            ...
            <div class="bg-serv-bg-explore overflow-hidden">
                <div class="pt-8 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 mx-auto">
                    <div class="text-center">
                        <h1 class="text-3xl font-semibold mb-1">About Us</h1>
                    ...
                    <div class="flex lg:pb-20 lg:px-16 md:px-16 sm:px-8 px-8 pb-16 lg:pl-24 md:pl-16 sm:pl-8 mx-auto">
                        <!-- Left Column -->
                        <div
                            class="mob:text-center lg:flex-grow lg:w-1/3 flex flex-col lg:items-start lg:text-left mb-3 md:mb-12 lg:mb-0 items-center">
