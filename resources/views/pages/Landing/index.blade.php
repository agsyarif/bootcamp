...
@section('content')
            ...
            <div class="flex lg:pb-20 lg:px-16 md:px-16 sm:px-8 px-8 pb-16 lg:pl-24 md:pl-16 sm:pl-8 mx-auto">
                ...
                <div
                    ...
                    <p
                        ...
                        On.coding mentransformasi para pemula <br class="lg:block hidden">
    ...
    <div class="content">
        ...
        <div class="bg-serv-services-bg">
            <div class="pt-16 pb-16 lg:pb-20 lg:pl-24 md:pl-16 sm:pl-8 mx-auto mob:p20">
                ...
                <div class="mob:text-center flex flex-col w-full mb-5">
                    <h1 class="mob:font1 md:text-4xl text-3xl tracking-wider font-semibold text-medium-black">
                        Kenapa Harus Belajar Di On.coding
                    </h1>
                    <p
                        class="mob:text-center mob:p-style text-lg leading-relaxed text-serv-text font-light tracking-wide lg:mb-18 ">
                        Karena kamu akan mendapatkan kesempatan untuk menjalin hubungan baik dengan industri
                        teknologi, <br class="lg:block hidden">
                        serta mendapatkan kesempatan untuk mengembangkan skillset yang dibutuhkan oleh industri
                        teknologi. <br class="lg:block hidden">
                    </p>
                </div>
        ...
        <div class="overflow-hidden">
            <div class="pt-16 lg:pb-20 lg:pl-24 md:px-16 sm:px-8 px-8 mx-auto">
                <div class="mob:text-center flex flex-col w-full">
                    <h1 class="mob:font1 md:text-4xl text-3xl tracking-wider font-semibold text-medium-black">
                        Pilih Jalur Belajar Kamu
                    </h1>
                    <p class="text-lg leading-relaxed text-serv-text font-light mb-5">
                        Kamu dapat memilih jalur yang sesuai dengan kebutuhan kamu.
                    </p>
                </div>
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper flex justify-between">
                        <div class="swiper-slide">
                            <div class="flex flex-col items-center p-6 max-w-sm rounded-lg border border-gray-200 shadow-md">
                                <img src="{{ asset('/assets/images/path-fe.png') }}" alt="Frontend Development" class="mb-3 w-24 h-24 rounded-full shadow-lg">
                                <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900">Frontend Development</h5>
                                <p class="font-normal text-gray-700 text-center">Pelajari cara membuat tampilan website yang tidak hanya interaktif tetapi juga user-friendly. Kembangkan kemampuan untuk mengimplementasikan desain yang responsif dan menarik.</p>
                                <a href="#" class="mt-3 text-indigo-500 hover:text-indigo-400">Pelajari lebih lanjut</a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="flex flex-col items-center p-6 max-w-sm rounded-lg border border-gray-200 shadow-md">
                                <img src="{{ asset('/assets/images/path-be.png') }}" alt="Backend Development" class="mb-3 w-24 h-24 rounded-full shadow-lg">
                                <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900">Backend Development</h5>
                                <p class="font-normal text-gray-700 text-center">Fokus pada pengembangan server, database, dan aplikasi. Pelajari bagaimana mengelola dan mengintegrasikan teknologi backend untuk mendukung frontend website atau aplikasi.</p>
                                <a href="#" class="mt-3 text-indigo-500 hover:text-indigo-400">Pelajari lebih lanjut</a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="flex flex-col items-center p-6 max-w-sm rounded-lg border border-gray-200 shadow-md">
                                <img src="{{ asset('/assets/images/path-mobile.png') }}" alt="Mobile Development" class="mb-3 w-24 h-24 rounded-full shadow-lg">
                                <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900">Mobile Development</h5>
                                <p class="font-normal text-gray-700 text-center">Pelajari pengembangan aplikasi mobile yang efisien dan responsif. Kuasai platform seperti Android dan iOS, serta teknologi cross-platform untuk menciptakan aplikasi yang optimal dan user-friendly.</p>
                                <a href="#" class="mt-3 text-indigo-500 hover:text-indigo-400">Pelajari lebih lanjut</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-serv-services-bg py-10 lg:py-24 flex lg:flex-row flex-col items-center cta-bg">
            ...
            <div class="lg:w-1/2 w-full flex flex-col lg:items-start items-center lg:text-left text-center mob:p20">
                <h1 class="mob:font1 md:text-4xl text-3xl font-semibold mb-10 lg:leading-normal text-medium-black">
                    Konsultasi dengan.
                    <br>
                    Representatif On.coding.
                </h1>

                <p class="text-lg leading-relaxed text-serv-text font-light mb-10 lg:mb-18">
                    Kami membantu Anda dalam membuat pilihan,
                    <br class="lg:block hidden">
                    namun keputusan akhir tetap di tangan Anda. <br class="lg:block hidden">
                </p>
        ...
        <!-- services -->
        <div class="overflow-hidden">
            <div class="pt-16 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 mx-auto">
                <div class="flex flex-col w-full text-center py-5">
                    <h1 class="mob:font1 md:text-4xl text-3xl tracking-wider font-semibold text-medium-black">
                        Success Stories
                    </h1>
                    <p class="text-lg leading-relaxed text-serv-text font-light mb-5 lg:mb-18">
                        Menurut Alumni
                    </p>
                </div>
                        ...
                        <div class="inline-block px-5">
                            <div class="w-80 h-90 overflow-hidden md:p-5 p-4 bg-white rounded-md inline-block">
                                <div class="flex items-center space-x-2 mb-6">
                                    <img src="{{ asset('/assets/images/user.png') }}" alt="foto alumni"
                                        loading="lazy" class="w-14 h-14 object-cover rounded-full mr-1">
                                    <div>
                                        <p class="text-gray-900 font-semibold text-lg">Nama Alumni {{$i}}</p>
                                        <p class="text-serv-text font-light text-md">
                                            Alumni Pengembang Web
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex items-start px-4 py-6">
                                        <div class="w-full">
                                            ...
                                            <p class="mt-3 text-gray-700 text-md leading-8">
                                                Program ini sangat membantu saya dalam mengembangkan karir sebagai pengembang web. Materi yang diberikan sangat mendalam dan aplikatif.
                                            </p>
                                            <div class="mt-4 flex items-center">
                                                <div class="flex mr-2 text-serv-text text-md">
                                                    Dipublikasikan {{$i}} hari yang lalu
                                                </div>
                                            </div>
                                        </div>
                                    </div>
