        ...
        <div
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="px-6 pb-6 rounded-b-xl mx-10">
                    ...
                    <div
                        class="border border-gray-300 bg-serv-explore-button hover:bg-gray-300 rounded-lg flex text-center items-center space-x-2 my-3 mx-10 px-4">
                        ...
                        <a class="inline-block font-medium text-serv-button"
                            href="{{ route('user.login.google') }}">Sign In with Google
                        </a>
